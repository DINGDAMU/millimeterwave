            ...
            try {
                cfg.getPortAttributes().forEach(portAttributes -> {
                   ...
                   Device device = deviceService.getDevice(DeviceId.deviceId(deviceID));
                    ...
                    PortDescription portDescription = new DefaultPortDescription(portNumber,isEnabled,annotations_port);
                    deviceProviderService.portStatusChanged(device.id(), portDescription);
