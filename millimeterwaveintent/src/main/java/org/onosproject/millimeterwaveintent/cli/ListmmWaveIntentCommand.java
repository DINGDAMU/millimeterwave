...
/**
 * Created by dingdamu on 2017/3/18.
 */
@Command(scope = "onos", name = "mmwave-intents",
        description = "Lists the inventory of intents and their states")
public class ListmmWaveIntentCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        ...
        if (intentsSummary) {
            ListmmWaveIntentCommand.IntentSummaries intentSummaries = new ListmmWaveIntentCommand.IntentSummaries();
    ...
    private class IntentSummaries {
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryAll;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryConnectivity;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryHostToHost;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryPointToPoint;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryMultiPointToSinglePoint;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summarySinglePointToMultiPoint;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryPath;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryLinkCollection;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryOpticalCircuit;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryOpticalConnectivity;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryOpticalOdu;
        private ListmmWaveIntentCommand.IntentSummaries.IntentSummary summaryUnknownType;

        /**
         * Initializes the internal state.
         */
        private void init() {
            summaryAll = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("All");
            summaryConnectivity = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("Connectivity");
            summaryHostToHost = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("HostToHost");
            summaryPointToPoint = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("PointToPoint");
            summaryMultiPointToSinglePoint =
                    new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("MultiPointToSinglePoint");
            summarySinglePointToMultiPoint =
                    new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("SinglePointToMultiPoint");
            summaryPath = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("Path");
            summaryLinkCollection = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("LinkCollection");
            summaryOpticalCircuit = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("OpticalCircuit");
            summaryOpticalConnectivity = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("OpticalConnectivity");
            summaryOpticalOdu = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("OpticalOdu");
            summaryUnknownType = new ListmmWaveIntentCommand.IntentSummaries.IntentSummary("UnknownType");
        }
    ...
    private String detailsFormat(IntentService service, Intent intent) {
        ...
        if (intent instanceof HostToHostIntent) {
            ...
            builder.append(String.format("    src=%s, dst=%d", ci.getSrc(), ci.getDst()));
        }
